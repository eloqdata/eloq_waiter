...
docker manifest create eloqdata/eloqctl-build-centos7 eloqdata/eloqctl-build-centos7-amd64
docker manifest push eloqdata/eloqctl-build-centos7

new_manifest() {
    IMG_KIND=$1
    IMG_OS=$2
    docker manifest create eloqdata/eloqctl-${IMG_KIND}-${IMG_OS} eloqdata/eloqctl-${IMG_KIND}-${IMG_OS}-amd64 eloqdata/eloqctl-${IMG_KIND}-${IMG_OS}-arm64
